...
export const techNewsAPI = {
  getAll: (params = {}) => api.get('/technews', { params }),
  getById: (id) => api.get(`/technews/${id}`),
  create: (data) => api.post('/technews', data),
  update: (id, data) => api.put(`/technews/${id}`, data),
  delete: (id) => api.delete(`/technews/${id}`),
};
