...
const Dashboard = () => {
  ...
  return (
    <div className="relative">
      {/* Background Video */}
      <div className="fixed top-0 left-64 right-0 bottom-0 z-0">
        <video
      ...
      <div className="relative z-10 p-6">
        <h2 className="text-2xl font-bold text-blue-600 mb-6 drop-shadow-lg">Dashboard</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => {
            ...
            return (
              <Card key={index}>
                <div className="flex items-center justify-between bg-white bg-opacity-95 rounded-lg p-4">
                  <div>
