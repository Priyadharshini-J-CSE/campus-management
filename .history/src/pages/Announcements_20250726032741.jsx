...
import { Plus, Megaphone, Calendar, UserCircle, Filter, Search, Bell } from 'lucide-react';
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500">
                        <div className="flex items-center space-x-1">
                          <UserCircle size={14} />
                          <span>{announcement.authorName || announcement.author?.name || announcement.author}</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <Calendar size={14} />
                          <span>{formatDate(announcement.createdAt || announcement.date)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
